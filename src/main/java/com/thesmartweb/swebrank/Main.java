...
public class Main {
    ...
    public static void main(String[] args){
        Path input_path=Paths.get("//mnt//var//DBs//inputs//softwareengineering//");//input directory
        String output_parent_directory="//mnt//var//DBs//outputs//softwareengineering//";//output directory
