...
public class MutualInformation
{
 public double LOG_BASE = 2.0;
   ...
   */
  public strictfp double calculateMutualInformation(double[] firstVector, double[] secondVector)
  { 
    try{  
    double answer;
    ...
    mutualInformation /= Math.log(LOG_BASE);
    
    return mutualInformation; 
    }
    catch (Exception ex){
        Logger.getLogger(MutualInformation.class.getName()).log(Level.SEVERE, null, ex);
        double mutualInformation=0.0;
        return  mutualInformation;
    }
      ...
      (double[] firstVector, double[] secondVector, double[] conditionVector)
  {
    ...
    double firstCondEnt = ep.calculateConditionalEntropy(secondVector, conditionVector);
    double secondCondEnt = ep.calculateConditionalEntropy(secondVector, mergedVector);
